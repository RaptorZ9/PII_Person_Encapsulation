...
{
    /// <summary>
    /// Valida un número de cédula de identidad; el número puede tener o no
    /// puntos y el guión pero debe tener el dígito verificador. Adaptado de
    /// https://es.wikipedia.org/wiki/C%C3%A9dula_de_Identidad_de_Uruguay#Match_on_Card.
    /// </summary>
    /// <param name="id">El número de cédula</param>
    /// <returns>Retorna true si el número de cédula es válido y false en caso
    /// contrario.</returns>
